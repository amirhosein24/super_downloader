...
def load_json():
    ...
    return admin, home, botToken, api_id, api_hash, forcejoin_id, forcejoin_name, sponsor, bot


Admin, Home, BotToken, ApiId, ApiHash, ForceJoindId, ForceJoindName, Sponser, Bot = load_json()
